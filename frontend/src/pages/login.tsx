...
export default function LoginPage() {
  ...
  return (
    <div className={styles.page}>
      ...
      <div className={styles.auroraSecondary} aria-hidden />
      <div className={styles.layout}>
        <section className={styles.hero}>
          <div className={styles.brandBadge}>Train API</div>
          <h1>Seu hub inteligente de treinos</h1>
          <p>
          ...
          <ul className={styles.featureList}>
            <li>
              ...
              Sincronização segura entre usuários convidados e treinadores.
            </li>
            <li>
              <span className={styles.featureIcon} aria-hidden>
                <svg viewBox="0 0 24 24" role="img">
              ...
              Histórico completo para você continuar exatamente de onde parou.
            </li>
            <li>
              <span className={styles.featureIcon} aria-hidden>
                <svg viewBox="0 0 24 24" role="img">
              ...
              Interface pensada para deixar o foco no desempenho da equipe.
            </li>
          </ul>
        </section>
        <div className={styles.panel}>
          <header className={styles.header}>
            <h2>Autenticação</h2>
            <p>Conecte-se com sua conta Google para desbloquear a melhor experiência da plataforma.</p>
          </header>
